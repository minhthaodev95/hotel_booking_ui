...
Future<DateTime?> showDatePicker({
  ...
  Widget dialog = DatePickerDialogCustom(
...
class DatePickerDialogCustom extends StatefulWidget {
  ...
  /// Restoration ID to save and restore the state of the [DatePickerDialogCustom].
  ///
...
/// push [DateRangePickerDialogCustom] when the button is tapped.
///
...
Future<DateTimeRange?> showDateRangePicker({
  ...
  Widget dialog = DateRangePickerDialogCustom(
...
class DateRangePickerDialogCustom extends StatefulWidget {
  ...
  State<DateRangePickerDialogCustom> createState() =>
      _DateRangePickerDialogCustomState();
}

class _DateRangePickerDialogCustomState
  ...
  Widget build(BuildContext context) {
    ...
    switch (_entryMode.value) {
      ...
      case DatePickerEntryMode.inputOnly:
        //input
        contents = _InputDateRangePickerDialogCustom(
          selectedStartDate: _selectedStart.value,
          selectedEndDate: _selectedEnd.value,
          currentDate: widget.currentDate,
          picker: Container(
...
const double _monthItemHeaderHeight = 48.0;
const double _monthItemFooterHeight = 8.0;
const double _monthItemRowHeight = 36.0;
const double _monthItemSpaceBetweenRows = 5.0;
  ...
  Widget _buildDayItem(BuildContext context, DateTime dayToBuild,
    ...
    if (isSelectedDayStart || isSelectedDayEnd) {
      ...
      decoration = BoxDecoration(
          ...
          borderRadius: (isSelectedDayStart)
              ? const BorderRadius.only(
                  topLeft: Radius.circular(8), bottomLeft: Radius.circular(8))
              : const BorderRadius.only(
                  topRight: Radius.circular(8), bottomRight: Radius.circular(8))
          // shape: (isSelectedDayStart) ? BoxShape.circle : BoxShape.rectangle,
          );
...
class _InputDateRangePickerDialogCustom extends StatelessWidget {
  const _InputDateRangePickerDialogCustom({
    Key? key,
    required this.selectedStartDate,
    required this.selectedEndDate,
    required this.currentDate,
